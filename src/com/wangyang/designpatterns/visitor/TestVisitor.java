...
import com.wangyang.designpatterns.visitor.impl.SubjectImpl;
import com.wangyang.designpatterns.visitor.impl.VisitorImpl;
 ...
 * 访问者模式将有关行为集中到一个访问者对象中，其改变不影响系统数据结构。其缺点就是增加新的数据结构很困难<br/>
 * <h3/>简单来说：访问者模式就是一种分离对象数据结构与行为的方法，通过这种分离，可达到为一个被访问者动态添加新的操作而无需做其它的修改的效果<h3/>
 */
